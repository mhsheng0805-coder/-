...
DEPT_EXPENSE_PPT = {dept: [
    '人事費(b)', '業務費(b)', '維護費(b)', '旅運費(b)', '材料費(b)',
    '產發署案配合款(b)', '配合款-其他民間(b)', '其他專案-民間(b)',
    '轉回專案設備使用費(b)',
    '衍生支出-研發成果', '衍生支出-研發成果(能專)', '衍生支出-其他', '衍生支出-成果下放',
...
def export_pptx():
    ...
    for dept_idx, dept in enumerate(DEPARTMENTS):
        ...
        # ─ 支出資料行 ─
        UNCL_MAP_EXP = {'業務費(b)': '業務費(未核銷)', '旅運費(b)': '旅運費(未核銷)',
                        '材料費(b)': '材料費(未核銷)', '維護費(b)': '維護費(未核銷)'}
